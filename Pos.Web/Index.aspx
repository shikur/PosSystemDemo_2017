<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Pos.Web.Index" %>
   ...
   <style>
    ...
    <div id="maindiv" style="width:100%; height:100%; min-height: !important 1700px; font-family:Arial">
        <div style="background-color:#ffffff; text-align:center">  
                             <b   style="width: !important  100%; color:#3276b1; ">Welcome Shikur Yennus  </b> 
            </div> 
        <table border="1" style="width:100%; height:100%">
            ...
            <tr class="posbgColor" style="height:20px; border-color:#3276b1"><td><a href="javascript:void(0)" class="posbgColor" id="lnkposMenu_ID">POS</a></td><td style="align-content:center; text-align:center"><a href="javascript:void(0)" class="posbgColor" id="lnkByItem_ID">By Item</a></td><td style="width:200px">
                 Search</td></tr></table>
    </div>
